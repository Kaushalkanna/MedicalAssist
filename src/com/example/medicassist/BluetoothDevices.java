...
public class BluetoothDevices extends Activity {
    ...
    // Message types sent from the BluetoothDevicesService Handler
    ...
    // Key names received from the BluetoothDevicesService Handler
   ...
   // private StringBuffer mOutStringBuffer;
    ...
    private BluetoothDeviceService mDevicesService = null;
    ...
    public void onStart() {
        ...
        // setupDevices() will then be called during onActivityResult
        if (!mBluetoothAdapter.isEnabled()) {
            Intent enableIntent = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
            startActivityForResult(enableIntent, REQUEST_ENABLE_BT);
        // Otherwise, setup the device session
        } else {
            if (mDevicesService == null) setupDevices();
        }
    }
    ...
    public synchronized void onResume() {
        ...
        if (mDevicesService != null) {
            // Only if the state is STATE_NONE, do we know that we haven't started already
            if (mDevicesService.getState() == BluetoothDeviceService.STATE_NONE) {
              // Start the Bluetooth device services
              mDevicesService.start();
            }
        }
    }

    private void setupDevices() {
        Log.d(TAG, "setupDevices()");
        ...
        // Initialize the BluetoothDevicesService to perform bluetooth connections
        mDevicesService = new BluetoothDeviceService(this, mHandler);
    ...
    public void onDestroy() {
        ...
        if (mDevicesService != null) mDevicesService.stop();
    ...
    // The Handler that gets information back from the BluetoothDevicesService
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case REQUEST_CONNECT_DEVICE:
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                mDevicesService.connect(device);
            }
            break;
    ...
    public void appendLog1(String deviceAddress, String text) { 
